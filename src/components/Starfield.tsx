 ...
 *
 * Dark theme only. On the light theme globals.css hides the whole layer,
 * because violet specks on a near-white page never earned their keep.
 *
...
export function Starfield() {
  return (
    <div
      ...
      // `.ens-starfield` (globals.css) carries that dimming, and hides the
      // layer outright on the light theme.
