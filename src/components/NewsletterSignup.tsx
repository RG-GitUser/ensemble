  ...
  return (
    <form action={formAction} className="site-btn-group mt-6 w-full max-w-md">
      <div className="flex flex-col gap-3 sm:flex-row">
        ...
        <input
          className="site-field w-full flex-1 site-round-xl px-4 py-3"
          name="email"
          type="email"
        ...
        />
        <button
          className="site-btn site-round-xl px-6 py-3 font-semibold text-white transition hover:opacity-90"
